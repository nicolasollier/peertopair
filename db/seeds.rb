...
event1 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: "Lunch", canceled: false, address: "8 rue des nanettes")
event1.save!
puts 'event1 done!'

user_event1 = UserEvent.new(user: user1, event: event1, ranking_done: false)
user_event1.save!
puts 'user_event1 done!'

event2 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: "Lunch", canceled: false, address: "8 rue des nanettes")
event2.save!
puts 'event2 done!'

user_event2 = UserEvent.new(user: user1, event: event2, ranking_done: false)
user_event2.save!
puts 'user_event2 done!'

event3 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: "Lunch", canceled: false, address: "8 rue des nanettes")
event3.save!
puts 'event3 done!'

user_event3 = UserEvent.new(user: user1, event: event3, ranking_done: false)
user_event3.save!
puts 'user_event3 done!'

event4 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: event_type.sample, canceled: false, address: "8 rue des nanettes")
event4.save!
puts 'event4 done!'

user_event4 = UserEvent.new(user: user2, event: event4, ranking_done: false)
user_event4.save!
puts 'user_event4 done!'

event5 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: event_type.sample, canceled: false, address: "8 rue des nanettes")
event5.save!
puts 'event5 done!'

user_event5 = UserEvent.new(user: user3, event: event5, ranking_done: false)
user_event5.save!
puts 'user_event5 done!'

event6 = Event.new(start_date: ("2022-03-04 12:00:00"), end_date: ("2022-03-04 14:00:00"),
format: Format.sample, event_type: event_type.sample, canceled: false, address: "8 rue des nanettes")
event6.save!
puts 'event6 done!'

user_event6 = UserEvent.new(user: user3, event: event6, ranking_done: false)
user_event6.save!
...
user_event7 = UserEvent.new(user: user1, event: event7, ranking_done: false)
user_event7.save!
